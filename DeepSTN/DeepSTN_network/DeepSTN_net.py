...
import DeepSTN_network.metrics as metrics
...
def DeepSTN(H=21,W=12,channel=2,      #H-map_height W-map_width channel-map_channel
    ...
    DeepSTN_model.compile(loss='mse', optimizer=Adam(lr), metrics=[metrics.pickup_rmse, metrics.pickup_mae, metrics.dropoff_rmse, metrics.dropoff_mae])
