...
if __name__ == "__main__":
    ...
    for iterate_index in range(iterate_num):
        ...
        stop = CustomStopper(monitor='mse', min_delta=0, patience=10, verbose=0, mode='min', start_epoch=100)

        model.fit([X_train_outflow, X_train_inflow], Y_train,
                  validation_data=([X_val_outflow, X_val_inflow], Y_val),
