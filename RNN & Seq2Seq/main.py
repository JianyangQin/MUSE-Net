...
from lib.metrics import masked_mae_test, masked_rmse_test, masked_mape_test, masked_mae
...
def train(args):
    ...
    # set model save path
    params_path = os.path.join('exps', model_name, dataset)
    ...
    if model_name == 'RNN':
        ...
        model = Seq2Seq(device, args.input_seq, args.output_seq, args.input_dim, args.hidden_dim, args.hidden_dim, args.input_dim, args.num_of_layers)
    else:
