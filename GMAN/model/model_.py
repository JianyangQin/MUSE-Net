...
class GMAN(nn.Module):
    ...
    def __init__(self, device, SE, args, bn_decay):
        ...
        self.STEmbedding = STEmbedding(device, D, bn_decay)
        ...
        self.FC_1 = FC(input_dims=[args.in_dim, D], units=[D, D], activations=[F.relu, None],
                       bn_decay=bn_decay)
        self.FC_2 = FC(input_dims=[D, D], units=[D, args.in_dim], activations=[F.relu, None],
                       bn_decay=bn_decay)
